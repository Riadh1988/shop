...
class CathegoryPro extends Component {
            ...
            <div className="col-4 mg-bottom">
                <div className="card">
                    ...
                    <div className="d-flex card-footer justify-content-between">
                        ...
                        <p className="mb-0 align-self-center price__footer">id-genre{this.props.product.genre.id}</p>
                    </div>
